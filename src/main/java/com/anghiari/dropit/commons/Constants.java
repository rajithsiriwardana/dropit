...
public enum Constants {
    ...
    REQ, RES, GET, RES_GET, PUT, RES_PUT, STORE, ACK_STORE, RETRIEVE, TRANSFER, PING, PONG, FND_SUSC, RES_SUSC, GOSSIP,
    GET_FILENODE, RES_GET_FILENODE, FILE_PATH, REQ_JOIN_NODE, RES_JOIN_NODE, REQ_JOIN_FINAL, RES_JOIN_FINAL, SEARCH,
    RES_SEARCH, SET_SUCCESSOR, SET_PREDECESSOR, ACK_SUCCESSOR, ACK_PREDECESSOR, ACK_FILE_SAVED, DELETE, ACK_DELETE,
    GET_PREDECESSOR, RES_GET_PREDECESSOR,
    /* Attribute keys */
